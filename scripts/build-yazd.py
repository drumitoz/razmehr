...
PLACES = [
    ...
    ("abarkuh-cypress", "سرو ابرکوه", "Abarkuh Cypress", "Eberkuh Servi Ağacı", "سرو أبركوه"),
...
STORIES = [
 {"id":"historic-yazd", "old":"yazd-1956", "new":"yazd-current", "years":("1956", "2020"), "credit":("National Cartographic Center of Iran", "Baharak Roshanbakhsh"), "license":("Public domain", "CC0 1.0"),
  ...
  "copy":{
   ...
   "tr":"1956 tarihli hava fotoğrafı, sık dokulu kenti ve sokak ağını gösteriyor. Daha yeni kare, kerpiç duvarların ve gölgeli geçitlerin arasına iniyor. UNESCO, Yezd'in kurak iklime uyum sağlayan kerpiç mimarisini, rüzgâr kulelerini ve kehriz sistemini vurguluyor.",
