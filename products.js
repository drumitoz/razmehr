...
const PRODUCTS = [
  { cat:{fa:"مکمل رنگ",tr:"Renk Takviyesi",en:"Color Supplement"}, catKey:"color", tag:{fa:"ویژه",tr:"Özel",en:"Featured"},
    img:"img/volum.jpg", displayImg:"img/product-scene/volum.webp", name:{fa:"ولومایزر",tr:"VoluM@izer",en:"VoluM@izer"},
  ...
  { cat:{fa:"مراقبت مو",tr:"Saç Bakımı",en:"Hair Care"}, catKey:"hair", tag:{fa:"پرفروش",tr:"Çok Satan",en:"Bestseller"},
    img:"img/esprey.jpg", displayImg:"img/product-scene/esprey.webp", name:{fa:"اسپری ۲۰ کاره موراها",tr:"Moraha 20in1 Sprey",en:"Moraha 20in1 Spray"},
  ...
  { cat:{fa:"احیا مو",tr:"Saç Onarımı",en:"Hair Repair"}, catKey:"repair", tag:null,
    img:"img/freeze.jpg", displayImg:"img/product-scene/freeze.webp", name:{fa:"فریز — احیا مو",tr:"Freeze — Saç Onarımı",en:"Freeze — Hair Repair"},
  ...
  { cat:{fa:"احیا مو",tr:"Saç Onarımı",en:"Hair Repair"}, catKey:"repair", tag:{fa:"حرفه‌ای",tr:"Profesyonel",en:"Pro"},
    img:"img/plex.jpg", displayImg:"img/product-scene/plex.webp", name:{fa:"پلکس موراها — احیا مو",tr:"Moraha Plex",en:"Moraha Smart Plex"},
  ...
  { cat:{fa:"احیا مو",tr:"Saç Onarımı",en:"Hair Repair"}, catKey:"repair", tag:null,
    img:"img/lpp.jpg", displayImg:"img/product-scene/lpp.webp", name:{fa:"ماسک مو LPP & PPT زکابر",tr:"Zekaber LPP & PPT Maske",en:"Zekaber LPP & PPT Mask"},
  ...
  { cat:{fa:"احیا مو",tr:"Saç Onarımı",en:"Hair Repair"}, catKey:"repair", tag:{fa:"پرفروش",tr:"Çok Satan",en:"Bestseller"},
    img:"img/botax.jpg", displayImg:"img/product-scene/botax.webp", name:{fa:"ماسک بوتاکس مو زکابر",tr:"Zekaber Saç Botoks Maskesi",en:"Zekaber Hair Botox Mask"},
  ...
  { cat:{fa:"شامپو",tr:"Şampuan",en:"Shampoo"}, catKey:"shampoo", tag:null,
    img:"img/shampo.jpg", displayImg:"img/product-scene/shampo.webp", name:{fa:"شامپو ضد ریزش زکابر",tr:"Zekaber Dökülme Karşıtı Şampuan",en:"Zekaber Anti-Hair Loss Shampoo"},
  ...
  { cat:{fa:"احیا مو",tr:"Saç Onarımı",en:"Hair Repair"}, catKey:"repair", tag:{fa:"حرفه‌ای",tr:"Profesyonel",en:"Pro"},
    img:"img/coktail.jpg", displayImg:"img/product-scene/coktail.webp", name:{fa:"هیر کوکتل زکابر",tr:"Zekaber Hair Cocktail",en:"Zekaber Hair Cocktail"},
  ...
  { cat:{fa:"مراقبت مو",tr:"Saç Bakımı",en:"Hair Care"}, catKey:"hair", tag:null,
    img:"img/koster.jpg", displayImg:"img/product-scene/koster.webp", name:{fa:"اسپری دوفاز کستر انرژی",tr:"Koster Energy İki Fazlı Sprey",en:"Koster Energy Two-Phase Spray"},
